...
const BuatKomunitasContainer = () => {
    ...
    const {komunitas: {loading, detailKomunitas}, updateKomunitas, getDetailKomunitas} = useKomunitasDispatcher()
    ...
    useEffect(() => {
        if (detailKomunitas && detailKomunitas.namaKomunitas) {
            setInitialValues(
                {
                    namaKomunitas: detailKomunitas.namaKomunitas,
                    kategori: {id:detailKomunitas.kategori.id, name:detailKomunitas.kategori.namaGame},
                    deskripsi: detailKomunitas.deskripsi,
                    lokasi: {name:detailKomunitas.lokasi},
                    banner: detailKomunitas.banner
                }
            )
        }
        if (detailKomunitas.banner  && detailKomunitas.namaKomunitas) {
            setPreview(detailKomunitas.banner)
        }
    },[detailKomunitas])
                        ...
                        <form action="" onSubmit={handleSubmit} >
                            <div className="mt-2">
                                <Input
                                    ...
                                    name="namaKomunitas"
                                    id="namaKomunitas"
                                    value={detailKomunitas.namaKomunitas}
                                    type="text"
                            ...
                            <div className="mt-2">
                                ...
                                <SelectInput 
                                    ...
                                    // defaultVal={detailKomunitas.kategori.namaGame}
                                    // title="Nama Komunitas"
                                    name="kategori"
                                    id="kategoriGame"
                                />
                                {/* {detailKomuntasi.kategori && detailKomunitas && (
                                )} */}
                            </div>
                            <div className="mt-2">
                                <label>
                                    <span className="block text-white">Deskripsi Komunitas</span>
                                    <textarea value={detailKomunitas.deskripsi} type="text" name="deskripsi" onChange={handleChange} onBlur={handleBlur} id="" placeholder='Masukkan deskripsi komunitas' className='w-full h-full bg-darkmode-3 text-white outline-none p-3 rounded-md' />
                                </label>
                            </div>
                            <div className="mt-2">
                                ...
                                <SelectInput 
                                    ...
                                    // defaultVal={detailKomunitas.lokasi}
                                    title="lokasi"
                                    name="lokasi"
                                    id="lokasi  "
                                    />
                                {/* {detailKomunitas.lokasi && detailKomunitas && (
                                )} */}
                            </div>
                            <div className="mt-2">
                                <label htmlFor="file" >
                            ...
                            <div className="mt-2 mb-5">
                                {
                                    !errors.namaKomunitas || !errors.lokasi || !errors.kategori ? (
                                        <button type="submit" className="w-full p-2 bg-blue-500 text-white font-semibold rounded-md mt-2">{loading ? 'Sedang mengirim': 'Simpan'}</button>
                                    ):(
                                        <button disabled className="w-full p-2 bg-darkmode-disabled text-white font-semibold rounded-md mt-2">Simpan</button>
                                    )
                                }
                            </div>
